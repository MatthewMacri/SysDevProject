...
require_once 'app/Models/ApplicationUser.php';
class Usercontroller {
    ...
    public function changePasswordForm() {
        include 'resources/views/userChangePassword.php';
    }
    ...
    public function changePassword($postData) {
        ...
        $user = \App\Models\ApplicationUser::selectByUsername($pdo, $username);
